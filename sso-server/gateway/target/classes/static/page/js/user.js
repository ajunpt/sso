$(document).ready(
    function () {
        ...
        var datatable = dataTableInit('#datatable1', preffix+"/user/listUsers", colModel, [
        ...
        $("#modifyForm").submit(function (e) {
            ...
            $.ajax({
                url: preffix+"/user/modifyUser",//这个就是请求地址对应sAjaxSource
        ...
        $.ajax({
            url: preffix+"/listAllModules",//这个就是请求地址对应sAjaxSource
